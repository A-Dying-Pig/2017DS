...
void m_file_list::add(int webID, m_charstring<wchar_t> website, m_charstring<wchar_t> keyword, m_charstring<wchar_t> content, m_charstring<wchar_t> author, m_charstring<wchar_t> title, m_charstring<wchar_t> date)
{
    list_node *p = search(webID);
    if (p)
    {
